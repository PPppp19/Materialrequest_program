...
<html>
    ...
    <header class="header"  >
        ...
        <h2 align="center";  style=" color: #ffffff; font-weight: bold"> History  </h2>
    ...
    <br>
     <h5 align="center";  style=" color: #ffffff; font-weight: bold"> Status *  </h5>
          <h5 align="center";  style=" color: #ffffff; font-weight: bold"> Requester = 'เกิดเลขออเดอร์แต่ยังไม่ไปที่หัวหน้า' , Department Head = 'รอหัวหน้าapprove' , Storing = 'รอ Store ตัด'  </h5>
...
////                                            && (!filter.CRE_DATE || (item.CRE_DATE.indexOf(filter.CRE_DATE) > -1))
//                                            && (filter.CRE_DATE.from === "01/01/1970" || formattedToday == filter.CRE_DATE.from)
//                                            && (filter.ORD_REMAR.from === "01/01/1970" || formattedToday == filter.ORD_REMAR.from)
...
//                                            && (!filter.ORD_STAT || (item.ORD_STAT.indexOf(filter.ORD_STAT) > -1)
    ...
    return (!filter.ORD_ID || (item.ORD_ID.indexOf(filter.ORD_ID) > -1))
                    ...
                    fields: [
                        ...
                        {title: "Status", name: "ORD_STAT", type: "select", items: countries, valueField: "Id", textField: "Name", width: 3,
                            itemTemplate: function (value, item) {
                                if (value === "99") {
                                    return "Reject";
                                } else if (value === "00") {
...
//                        {name: "WAH_LOCA", type: "text", width: 3},
//                        {name: "ORD_PURP", type: "text", width: 3},
                        {title: "Creator", name: "ORD_REGB", type: "text", width: 3},
//                        {name: "RQT_DATE", type: "text", width: 3},
//                        {name: "DPM_HEAD", type: "text", width: 3},
                        {title: "Dept_H", name: "ORD_DPMH", type: "text", width: 3},
//                        {name: "DPH_DATE", type: "text", width: 3},
                        {title: "Approval", name: "ORD_ISSB", type: "text", width: 3},
//                        {name: "ISB_DATE", type: "text", width: 3},
