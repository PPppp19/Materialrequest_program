    ...
    public static void ROLLBACK(String cono, String divi, String ordid) throws Exception {
        ...
        try {
            if (conn != null) {
                ...
                String query = " UPDATE BRLDTA0100.FAR_MTRREQ04 fm  \n"
    ...
    public static void SETITEM(String cono, String divi, String ordid) throws Exception {
        ...
        try {
            if (conn != null) {
                ...
                Statement stmt = conn.createStatement();
                String query = " UPDATE BRLDTA0100.FAR_ITMTLB04 fm  \n"
                        + " SET ONH_STAT  = 'YES'\n"
                        + " WHERE ORD_ID  = '" + ordid.trim() + "'";
    ...
    public static void updateusername(String username, String id, String datetime) throws Exception {
        ...
        try {
            if (conn != null) {
                ...
                Statement stmt = conn.createStatement();
                String query = "UPDATE BRLDTA0100.FAR_MTRREQ04\n"
    ...
    public static void updateitemdata(String id, String itid, String code, String desc, String unit, String reqt, String issu, String onhand) throws Exception {
        ...
        try {
            if (conn != null) {
                ...
                Statement stmt = conn.createStatement();
                String query = "UPDATE BRLDTA0100.FAR_ITMTLB04\n"
